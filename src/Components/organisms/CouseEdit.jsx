    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full border border-stroke bg-surface text-ink rounded-md px-2 py-1"
          >
      ...
      <div>
        ...
        <textarea
          ...
          onChange={handleChange}
          className="w-full border border-stroke bg-surface text-ink rounded-md px-2 py-1 min-h-[80px]"
        />
      </div>
